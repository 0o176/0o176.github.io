...
![nmap](/docs/img/HTB-Timelapse/img/nmap.PNG)
...
![SMB](/docs/img/HTB-Timelapse/img/smb1.png)
...
![zip_hash](/docs/img/HTB-Timelapse/img/zip_hash.png)

```powershell
john ziphash.txt --wordlist=~/Tools/rockyou.txt
```

![zip_hash2](/docs/img/HTB-Timelapse/img/zip_hash2.png)

And we have out first password! **supremelegacy**

The zip contains single file: **legacyy_dev_auth.pfx**

![unzip](/docs/img/HTB-Timelapse/img/unzip.png)
...
![pfx1](/docs/img/HTB-Timelapse/img/pfx1.png)
...
```
![pfx2](/docs/img/HTB-Timelapse/img/pfx2.png)

```powershell
john pfx_hash --wordlist=~/Tools/rockyou.txt
```

![pfx3](/docs/img/HTB-Timelapse/img/pfx3.png)
...
![key1](/docs/img/HTB-Timelapse/img/key1.png)
...
![key2](/docs/img/HTB-Timelapse/img/key2.png)
...
![winrm1](/docs/img/HTB-Timelapse/img/winrm1.png)

And we can get our user flag

![user_flag](/docs/img/HTB-Timelapse/img/user_flag.png)
...
![priv](/docs/img/HTB-Timelapse/img/priv.png)

```powershell
net user legacyy
```

![groups](/docs/img/HTB-Timelapse/img/groups.png)
...
![ps_history1](/docs/img/HTB-Timelapse/img/ps_history1.png)
...
![winrm_svc2](/docs/img/HTB-Timelapse/img/winrm_svc2.png)
...
![adm_pass](/docs/img/HTB-Timelapse/img/adm_pass.png)

### Method 1: PowerView

We can upload `PowerView.ps1` 

![powerview1](/docs/img/HTB-Timelapse/img/powerview1.png)

Import it to PS

![powerview2](/docs/img/HTB-Timelapse/img/powerview2.png)

And use `Get-ADComputer` module to get admin password.

![powerview3](/docs/img/HTB-Timelapse/img/powerview3.png)

## Log in as admin

With the admin credentials we can once again use `evil-winrm` to log in and grab the root flag.

![admin_login](/docs/img/HTB-Timelapse/img/admin_login.png)

![root_flag](/docs/img/HTB-Timelapse/img/root_flag.png)
